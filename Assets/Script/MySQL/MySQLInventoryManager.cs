...
//public class MySQLInventoryManager : MonoBehaviour
//{
//    private static MySQLInventoryManager _instance;
//    public static MySQLInventoryManager Instance => _instance;
...
//        catch (Exception e)
//        {
//            Debug.LogError($"MySQL数据库配置失败: {e.Message}");
//        }
//    }
...
//        catch (Exception e)
//        {
//            Debug.LogError($"数据库初始化错误: {e.Message}");
//        }
//    }
